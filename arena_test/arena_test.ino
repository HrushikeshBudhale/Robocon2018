...
int state = 0;
char flag = 0;  // permission for setting state
...
void loop(){
    if(run == 1){
        ...
        switch(state){
           ...
           case 0:  if(pos_wrt_left > 106132 || flag == 1){  // To left
                        stop();
                        state = 1;
                        front_dest = -74882;
                        left_dest = 0;
           ...
           case 1:  if(pos_wrt_front < -74882 || flag == 1){    // TO 1st throw
                        stop();
                        state = 2;
                        front_dest = 74882;
                        left_dest = 0;
           ...
           case 2:  if(pos_wrt_front > 74882 || flag == 1){ // To home
                        stop();
                        state = 3;
                        left_dest = 47169;
                        front_dest = 0;
           ...
           case 3:  if(pos_wrt_left > 47169 || flag == 1){   // TO corner
                        stop();
                        state = 4;
                        front_dest = -74882;
                        left_dest = 0;
           ...
           case 4:  if(pos_wrt_front < -74882 || flag == 1){    // To 2nd pos
                        stop();
                        state = 5;
                        front_dest = 74882;
                        left_dest = 0;
           ...
           case 5:  if(pos_wrt_front > 74882 || flag == 1){ // To corner
                        stop();
                        state = 6;
                        front_dest = -149646;
                        left_dest = 0;
           ...
           case 6:  if(pos_wrt_front < -149646 || flag == 1){   // To 3rd pos
                        stop();
                        state = 7;
                        stringComplete = true;
                        front_dest = 0;
